...
<body>
    <div class="sidebar close">
        ...
        <ul class="nav-links">
            <li>
                <div class="iocn-link">
                    <a href="<?= base_url("programmer/dashboard/"); ?>">
    ...
    <section class="home-section">
        ...
        <!-- Tambahkan tag modal di dalam file dashboard.php -->
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <center><p>Hello Mr. <?= $this->session->userdata('username');?></p>
                        <?php 
                            $username = $this->session->userdata('username');
                            $this->db->where('username', $username); 
                            $data_programmer = $this->db->get('programmer')->result();
                            foreach($data_programmer as $v_data){
                        ?>
                        <img class="img_programmer" src="<?= base_url('/assets/programmer/'.$v_data->image) ?>">
                        <?php
                            }
                        ?>
                        </center>
